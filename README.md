...
**Windows:** double-click `nirmana_agent.bat`.

**Any OS:** `python3 nirmana_agent.py`
...
- `nirmana_agent.bat` / `nirmana_agent.ps1` — double-click launchers (Windows).
- `nirmana_agent.py` — driver: prompts you for the board, then loops turn to turn.
